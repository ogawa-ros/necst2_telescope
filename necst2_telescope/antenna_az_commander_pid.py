...
class antenna_az_feedback(object):
    ...
    def __init__(self):
        ...
        self.MOTOR_AZ_MAXSPEED = self.node.get_parameter("MOTOR_AZ_MAXSPEED").get_parameter_value().string_value # name?
        ...
        topic_from1 = rclpy.node.create_subscription(Float64, topic_name['from1'], self.antenna_az_feedback, 1)
        topic_from2 = rclpy.node.create_subscription(Float64, topic_name['from2'], self.antenna_az_encoder, 1)
        pass
